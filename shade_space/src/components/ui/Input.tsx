...
export function Input({ label, error, errorKey, isSuccess = false, isSuggestedTypo = false, className = '', ...props }: InputProps) {
  ...
  return (
    <div>
      ...
      <input
        className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 transition-all duration-200 bg-white text-[#01312D] shadow-sm hover:shadow-md ${
          ...
          isSuccess ? 'border-emerald-500 bg-emerald-50 focus:ring-emerald-500 focus:border-emerald-500' : 
